...
#define aw8838_l_FLAG_START_ON_MUTE   (1 << 0)
#define aw8838_l_FLAG_SKIP_INTERRUPTS     (1 << 1)
#define aw8838_l_FLAG_SAAM_AVAILABLE      (1 << 2)
#define aw8838_l_FLAG_STEREO_DEVICE       (1 << 3)
#define aw8838_l_FLAG_MULTI_MIC_INPUTS    (1 << 4)

#define aw8838_l_NUM_RATES                9

#define aw8838_l_MAX_REGISTER             0xff


enum aw8838_l_chipid{
    aw8838_l_ID,
};

enum aw8838_l_mode_spk_rcv{
    aw8838_l_SPEAKER_MODE = 0,
    aw8838_l_RECEIVER_MODE = 1,
};
