...
enum {
	POWER_SUPPLY_BATTERY_TYPE_UNKNOWN = 0,
	POWER_SUPPLY_BATTERY_TYPE_MAIN,
	POWER_SUPPLY_BATTERY_TYPE_SLAVE,
};
...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_POGO,			/* POGO Port */
};
...
enum power_supply_usb_type {
	...
	POWER_SUPPLY_USB_TYPE_POGO,		/* Pogo Charging Method */
};
