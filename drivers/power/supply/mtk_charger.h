...
#include "../../../include/linux/power_supply.h"
...
enum bat_protect_mode_state {
	BAT_PROTECT_SOC_UNKNOWN = 0,
	BAT_PROTECT_SOC_BELOW_40,
	BAT_PROTECT_SOC_40_TO_60,
	BAT_PROTECT_SOC_ABOVE_60,
};
...
struct charger_custom_data {
	...
	int temp_t2_thres_minus_x_degree;
	int temp_t1_thres;
	int temp_t1_thres_plus_x_degree;
	int temp_t1_thres_minus_x_degree;
	int temp_t0_thres;
...
extern void update_battery_status(struct power_supply *psy, int val);
extern void update_battery_charge_status(struct power_supply *psy, int val);
