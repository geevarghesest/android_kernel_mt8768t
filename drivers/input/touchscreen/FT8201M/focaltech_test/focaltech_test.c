...
/*add for tp_selftest need*/
#define CONF_MULTIPLETEST_INI "Conf_MultipleTest.ini"
#define CONF_MULTIPLETEST_ft8201AB_INI "Conf_MultipleTest_ft8201AB.ini"
#define CONF_MULTIPLETEST_ft8201M_INI "Conf_MultipleTest_ft8201M.ini"
...
int lct_tp_selftest_all(void)
{
	...
	if(!r1){
    	...
    	FTS_TEST_DBG("fwname:%s.", fwname);
		FTS_INFO("fwname is Conf_MultipleTest.ini");
		}
	else if(!r2){
		sprintf(fwname, "%s", CONF_MULTIPLETEST_ft8201AB_INI);
		FTS_TEST_DBG("fwname:%s.", fwname);
		FTS_INFO("fwname is Conf_MultipleTest_ft8201AB.ini");
		}
	else{
		sprintf(fwname, "%s", CONF_MULTIPLETEST_ft8201M_INI);
		FTS_TEST_DBG("fwname:%s.", fwname);
		FTS_INFO("fwname is Conf_MultipleTest_ft820M.ini");
	}
