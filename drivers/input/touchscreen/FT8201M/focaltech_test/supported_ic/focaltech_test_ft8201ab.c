...
*
* File Name: Focaltech_test_ft8201ab.c
*
...
*****************************************************************************/
static int ft8201ab_short_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    int i = 0;
    ...
    for (i = 0; i < tdata->node.node_num; i++) {
        ...
        adcdata[i] = (65 * tmp_adc + 20480) / (4096 - tmp_adc);
    }
...
test_err:
    ...
    if (tmp_result) {
        *test_result = true;
		...
		FTS_INFO("------ Short Circuit Test PASS\n");
    } else {
        *test_result = false;
        FTS_TEST_SAVE_INFO("------ Short Circuit Test NG\n");
		FTS_INFO("------ Short Circuit Test NG\n");
    }
...
static int ft8201ab_open_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    int i = 0;
    bool tmp_result = false;
...
test_err:
    ...
    if (tmp_result) {
        *test_result = true;
		...
		FTS_INFO("------ Open Test PASS\n");
    } else {
        *test_result = false;
        FTS_TEST_SAVE_INFO("------ Open Test NG\n");
		FTS_INFO("------ Open Test NG\n");
    }
...
static int ft8201ab_cb_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    bool tmp_result = false;
    int byte_num = 0;
...
static int ft8201ab_rawdata_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    bool tmp_result = false;
    int *rawdata = NULL;
...
static int ft8201ab_lcdnoise_test(struct fts_test *tdata, bool *test_result)
{
    int ret = 0;
    int i = 0;
    bool tmp_result = false;
...
test_err:
    ...
    if (tmp_result) {
        *test_result = true;
		...
		FTS_INFO("------ LCD Noise Test PASS\n");
    } else {
        *test_result = false;
        FTS_TEST_SAVE_INFO("------ LCD Noise Test NG\n");
		FTS_INFO("------ LCD Noise Test NG\n");
    }
...
static int start_test_ft8201ab(void)
{
    int ret = 0;
    ...
    if (true == test_item->short_test) {
        ret = ft8201ab_short_test(tdata, &temp_result);
    ...
    if (true == test_item->open_test) {
        ret = ft8201ab_open_test(tdata, &temp_result);
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
        }
    }
    ...
    if (true == test_item->cb_test) {
        ret = ft8201ab_cb_test(tdata, &temp_result);
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
        }
    }
    ...
    if (true == test_item->rawdata_test) {
        ret = ft8201ab_rawdata_test(tdata, &temp_result);
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
        }
    }
    ...
    if (true == test_item->lcdnoise_test) {
        ret = ft8201ab_lcdnoise_test(tdata, &temp_result);
        if ((ret < 0) || (false == temp_result)) {
            test_result = false;
        }
    }
...
struct test_funcs test_func_ft8201ab = {
    .ctype = {0x21},
    .hwtype = IC_HW_INCELL,
    .key_num_total = 0,
    .start_test = start_test_ft8201ab,
};
