 ...
 *
 * $Revision: 72393 $
 * $Date: 2020-11-17 11:15:22 +0800 (週二, 17 十一月 2020) $
 *
...
info_retry:
	...
	sprintf(fw_version, "[Vendor]novatek,[FW]0x%02x,[IC]nt36523b", ts->fw_ver);
	init_tp_fm_info(fw_version);
...
#endif
	int r;
	r = strcmp(mtkfb_lcm_name,"nt36523_wxga_vdo_inx");
	if(r){
		NVT_ERR("driver_init fail");
		return -EINVAL;
	}
