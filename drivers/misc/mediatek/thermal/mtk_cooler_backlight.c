...
#ifdef CONFIG_BACKLIGHT_SUPPORT_4095_FEATURE
		case 0:
			setMaxbrightness(4095, 0);	/* 100% */
			break;
		case 1:
			setMaxbrightness(2866, 1);	/* 70% */
			break;
		case 2:
			setMaxbrightness(1638, 1);	/* 40% */
			break;
		case 3:
			setMaxbrightness(409, 1);	/* 10% */
			break;
		default:
			setMaxbrightness(4095, 0);
			break;
#else
		case 0:
