...
#define AW9610X_BIT_REG_RSTALL_MASK			~1
#define AW9610X_BIT_REG_RSTALL_EN			1
#define AW9610X_BIT_REG_HOSTIRQEN_MASK			(~(1<<4))
#define AW9610X_BIT_REG_HOSTIRQEN_EN			(1<<4)
