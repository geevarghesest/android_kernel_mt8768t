...
//Interrupt and config
	...
	},
	{
		...
		.val = 0x85,       //Sampling Freq(ph0/1) : 83.33khz(01000), Resolution(ph0/1) : 128(100)
	},
	{
	...
	},
	{
		...
		.val = 0x00,       //big//Analog Range(ph2/3) : Small
	},
	{
		.reg = SX932x_AFE_CTRL7_REG,   //0x27
		.val = 0x85,       //Sampling Freq(ph2/3) : 83.33khz(01000), Resolution(ph2/3) : 128(100)
	},
	{
		.reg = SX932x_AFE_PH0_REG,   //0x28
		.val = 0x3D,       // CS2:HZ CS1:Input CS0 :HZ
	},
	{
		.reg = SX932x_AFE_PH1_REG,     //0x29
		.val = 0x37,       // CS2:Input CS1:HZ Shield CS0 :HZ
	},
	{
		.reg = SX932x_AFE_PH2_REG,   //0x2A
		.val = 0x1F,       //CS2:HZ CS1:HZ CS0 :HZ  
	},
	{
		.reg = SX932x_AFE_PH3_REG,   //0x2B
		.val = 0x3F,       //CS2:HZ CS1:HZ CS0 :HZ
	},
	{
...
static struct _buttonInfo psmtcButtons[] = {
	{
		.keycode = KEY_SARCS0,
		.keycode_release = KEY_SAR_RELEASECS0,
		.mask = SX932x_PROXSTAT_PH0_FLAG,
		
	},
	{
		.keycode = KEY_SARCS1,
		.keycode_release = KEY_SAR_RELEASECS1,
		.mask = SX932x_PROXSTAT_PH1_FLAG,
	},
	{
		.keycode = KEY_SARCS2,
		.keycode_release = KEY_SAR_RELEASECS2,
		.mask = SX932x_PROXSTAT_PH2_FLAG,
	},
	{
		.keycode = KEY_SARCS3,
		.keycode_release = KEY_SAR_RELEASECS3,
